...
function FormValidate(e) {
  ...
  return (
    ...
    <form action="" method="post" onSubmit={handleSubmit(FormValidate)}>
      ...
      <Box sx={{width:"100%",display:'flex',justifyContent:"space-around",alignItems:"center",borderRadius:"25px"}}>
      <Link to='/'><Button sx={{borderRadius:'28px'}} variant='outlined'>Cancel</Button></Link>
      <Button variant='contained' sx={{borderRadius:'28px',backgroundColor:'dodgerblue'}} type='submit' endIcon={<ArrowForward/>} >Login</Button>
      </Box>
    </Card>
    </form>
    </Box>

...
const OrderDetail = () => {
  ...
  return (
    <Box className='OrderDetail' sx={{paddingBottom:'30px'}} >
      ...
      }
      {
        ...
        <Box sx={{display:'flex',alignItems:'center',padding:1,justifyContent:'end'}}>
         <Button onClick={()=>onSubmit(data.id)} color='error' sx={{borderRadius:'28px'}} type='button' variant='contained'>Cancel Booking</Button>
        </Box>

      ...
      }
        {
            ...
            <Typography component='p'>Reserved : {table.reservation.name || " NA "}</Typography>
            {
                table.status==="Available" && <Typography component='div'><Link to='/booking'>
                    <Button color='primary' sx={{borderRadius:'28px'}} variant='outlined'>Book Now</Button>
                    </Link></Typography>
            }
        </Card>
            :<Typography sx={{textAlign:'center',color:'dodgerblue',fontSize:'30px',padding:'40px 0'}} component='p'> No Tables Available</Typography>
        }
